...
// Constants
const EMBEDDING_DIMENSIONS = 768;  // paraphrase-multilingual-mpnet-base-v2 (best for Hindi/multilingual)
const MAX_METADATA_TEXT_LENGTH = 8000;  // Pinecone metadata size limit
const DEFAULT_SCORE_THRESHOLD = 0.0;  // No threshold - use all top-K results
